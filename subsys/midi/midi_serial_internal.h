...
#define COMPAT_MIDI_SERIAL_DEVICE midi_serial_device
...
#define MIDI_DEVICE_COUNT  DT_NUM_INST_STATUS_OKAY(COMPAT_MIDI_SERIAL_DEVICE)
...
#define MIDI_SERIAL_DEV_N_ID(dev)	        DT_INST(dev, COMPAT_MIDI_SERIAL_DEVICE)
#define SERIAL_DEV_N_ID(dev)	    DT_PARENT(MIDI_SERIAL_DEV_N_ID(dev))
